            ...
            with con.cursor() as cur:  # start an entry cursor
                ...
                try:
                    ...
                    with pysftp.Connection(D118_SFTP_HOST, username=D118_SFTP_UN, password=D118_SFTP_PW, cnopts=CNOPTS) as sftp:
                        ...
                        print("Activities file placed on remote server for " + str(today))
                        print("Activities file placed on remote server for " + str(today), file=log)
                except Exception as er:
